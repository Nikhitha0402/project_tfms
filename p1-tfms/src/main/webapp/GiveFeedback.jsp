...
<body>
	...
	<div>
		...
		<div class="breadcrumbs" data-oas="fade-in" style="margin-top:3px">
			<div class="container">
				<h3>Give Rating for following questions:</h3>
				<br>
			</div>
			</div>
			<%
			...
			rating: <input type="number" name=<%="fname" + i%> min="1" max="5">
			<%
			...
			%>
<p align="center">
<input type="Submit" class="get-started-btn" value="Submit Feedback">
			</p>
